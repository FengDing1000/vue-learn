...
const createCanvas = {
    canvas1: function(that, ele) {
        ...
        var anim = function() {
            ...
            t += _t / 2;
            u -= .2;
            window.headerCanvasFrame = window.requestAnimationFrame(anim);
        };
        anim();
    ...
    canvas2: function(ele) {
        ...
        function baum() {
            ...
            window.headerCanvasFrame = requestAnimationFrame(baum);
        }
