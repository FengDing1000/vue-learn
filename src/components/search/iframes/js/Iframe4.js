    ...
    canvas: function(that, ele) {
        ...
        function draw(vars) {
            ...
            for (var i = 0; i < vars.points.length; ++i) {
                ...
                if (point.d != -1) {
                    ...
                    var a = .8 - Math.pow(d / (vars.vortexHeight / 2), 1000) * .8;
        ...
        function frame(vars) {
            if (vars === undefined) {
                ...
                vars.canvas.width = vars.canvas.clientWidth;
                vars.canvas.height = vars.canvas.clientHeight;
                window.addEventListener("resize", function() {
                    vars.canvas.width = ele.clientWidth;
                    vars.canvas.height = ele.clientHeight;
            ...
            vars.frameNo++;
            window.headerCanvasFrame = requestAnimationFrame(function() {
                frame(vars)
            });
            process(vars);
            draw(vars)
